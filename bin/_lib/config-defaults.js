 ...
 *
 * v2.3.18 (W1f): l1_compression_enabled retired along with the L1 pipeline
 * it gated (0/477 production prompts ever matched, per v2.2.20 audit —
 * see .orchestray/kb/artifacts/v2220-l1-revival-design.md §Executive Verdict).
 * The key no longer exists; inject-tokenwright.js never compresses prompts.
 */
