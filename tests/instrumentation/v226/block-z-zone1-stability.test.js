 ...
 *   T5. The pinned hash 10ff19f48322 (3-file, no shadow, \n\n join) is the
...
// ---------------------------------------------------------------------------
// T5: the pinned expected hash 10ff19f48322 matches 3-file no-shadow computation
...
// ---------------------------------------------------------------------------
describe('T5: pinned hash 10ff19f48322 regression guard', () => {
  test('current zone1 sources (3 files, no shadow, \\n\\n join) hash to 10ff19f48322', () => {
    ...
    //
    // NOTE: the hash 10ff19f48322 is only valid when the schema-shadow sentinel
    ...
    if (shadowDisabled) {
      ...
      assert.equal(
        hash.substring(0, 12), '10ff19f48322',
        'Zone1 3-file hash must match pinned value 10ff19f48322. ' +
