...
tools: Read, Bash, Write, Edit, mcp__orchestray__ask_user, mcp__orchestray__pattern_find, mcp__orchestray__kb_search, mcp__orchestray__history_query_events, mcp__orchestray__schema_get
model: inherit
effort: medium
memory: project
isolation: worktree
