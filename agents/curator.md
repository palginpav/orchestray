...
tools: Read, Write, Edit, mcp__orchestray__pattern_find, mcp__orchestray__pattern_deprecate, mcp__orchestray__curator_tombstone, mcp__orchestray__pattern_promote
model: sonnet
effort: medium
memory: project
maxTurns: 65
