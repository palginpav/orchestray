...
tools: Read, Bash, Write, mcp__orchestray__pattern_find, mcp__orchestray__history_query_events, mcp__orchestray__history_find_similar_tasks, mcp__orchestray__schema_get
model: inherit
effort: high
memory: project
maxTurns: 115
